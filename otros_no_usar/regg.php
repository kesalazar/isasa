...
include_once ('./funciones_librerias/db_connect.php');
$conexion=connect(); 
    ...
    { 
        ...
        { 
            ...
            { 
                ...
                $sql = "INSERT INTO usuarios (usuario,clave) VALUES ('$usuario','$password')";//Se insertan los datos a la base de datos y el usuario ya fue registrado con exito.
                mysqli_query($sql); 
